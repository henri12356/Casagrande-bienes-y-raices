...
const proyectosJson: ProjectJson[] = [
    ...
    subtitulo: "Ayacucho",
    categoria: "Lotes",
    ubicacion: "Al lado de Ccorihuillca Chico, en el mismo pueblo – Ayacucho",
    precioDesdeSol: "S/ 24000",
    precioDesdeDolar: "",
    pagoContado: "",
    ...
    descripcion:
      "EL GOLF DE CCORIHUILLCA es un nuevo proyecto de lotes ubicado al lado de Ccorihuillca Chico, en el mismo pueblo, a solo 10 minutos de Rancho Don Bruno – Ayacucho. Cuenta con 20 lotes de 180 m², con precio desde S/ 24,000. Es una excelente alternativa para vivienda, casa de campo o inversión, en una zona con servicios de agua, luz, acceso vehicular y buena proyección de crecimiento.",
    equipamiento: [
      "Acceso vehicular",
      "Agua",
      "Luz",
      "A 10 minutos de Rancho Don Bruno",
    ...
    caracteristicas: [
      { label: "Área típica", value: "180 m²" },
      { label: "Cantidad de lotes", value: "20 lotes" },
      { label: "Precio por lote", value: "S/ 24,000" },
      { label: "Ubicación", value: "Al lado de Ccorihuillca Chico" },
      { label: "Referencia", value: "A 10 minutos de Rancho Don Bruno" },
      { label: "Tipo de uso", value: "Vivienda / casa de campo / inversión" },
      { label: "Servicios", value: "Agua y luz" },
      { label: "Accesos", value: "Acceso vehicular" },
      { label: "Entorno", value: "Zona poblada con proyección de crecimiento" },
    ],
    mapsUrl: "https://maps.app.goo.gl/14ZJFdVR5BcMqidS9",
  },
  {
    ...
    subtitulo: "Ayacucho",
    categoria: "Lotes",
    ubicacion: "La Planicie, a 10 minutos de La Picota – Ccorihuillca, Ayacucho",
    precioDesdeSol: "S/ 18000",
    precioDesdeDolar: "",
    pagoContado: "",
    ...
    descripcion:
      "LA PLANICIE es un nuevo proyecto de lotes ubicado a solo 10 minutos de La Picota, en Ccorihuillca – Ayacucho. Cuenta con 24 lotes de 180 m², con precio desde S/ 18,000. Es una excelente alternativa para vivienda, casa de campo o inversión, en una zona con buena proyección de crecimiento y fácil acceso.",
    equipamiento: [
      "Acceso vehicular",
      "Agua",
      "Luz",
      "A 10 minutos de La Picota",
      "Zona con proyección de valorización",
    ],
    stockLotes: {
      total: 24,
    ...
    caracteristicas: [
      { label: "Área típica", value: "180 m²" },
      { label: "Cantidad de lotes", value: "24 lotes" },
      { label: "Precio por lote", value: "S/ 18,000" },
      { label: "Ubicación", value: "A 10 minutos de La Picota" },
      { label: "Tipo de uso", value: "Vivienda / casa de campo / inversión" },
      { label: "Accesos", value: "Acceso vehicular" },
      { label: "Entorno", value: "Zona con proyección de crecimiento" },
    ],
    mapsUrl: "https://maps.app.goo.gl/LXuFyntkEqqkTe2e7",
  },
  {
